...
export default function NovoOrcamentoForm({ toast }: Props) {
          ...
          <div className="w-full sm:max-w-lg bg-card rounded-t-2xl sm:rounded-2xl shadow-elevated max-h-[92dvh] flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 p-5">
              ...
              <div className="mt-6 flex gap-3">
                <button type="button" onClick={() => setOpen(false)} className="flex-1 rounded-lg border px-4 py-3 text-sm font-medium hover:bg-muted transition-colors">
                  Cancelar
                </button>
